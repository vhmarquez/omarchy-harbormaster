...
// Private synthetic cross-harness regression; never included in the production registry.
pub(crate) fn review_codex_entry(store: &mut ArtifactStore, source: &[u8]) -> super::ReplayEntry {
    let reviewed = &[Mapping {
        harness: HarnessKind::Codex,
        version: "synthetic-review-only-v1",
        turn: Source::Metadata,
        session: Source::Metadata,
        health_version: Source::Metadata,
    }];
