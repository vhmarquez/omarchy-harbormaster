...
**Stage: M1 and M2 #11–#12 are merged. The #13 candidate adds verified terminal
controls, retry reconciliation and shared-project warnings; its PR requires owner approval.**
