...
def plan(outside_canary="/outside-canary", scope="all"):
    ...
    portable = preflights + [
        ...
        ("rust-domain", cargo + ["test", "--locked", "--offline", "--workspace", "--test", "domain", "--all-features"], "rust"),
        ("rust-storage-reducer", cargo + ["test", "--locked", "--offline", "--workspace", "--test", "storage_reducer", "--all-features"], "rust"),
        ("rust-recovery", cargo + ["test", "--locked", "--offline", "--workspace", "--test", "recovery", "--all-features"], "rust"),
        ("rust-coordination", cargo + ["test", "--locked", "--offline", "--workspace", "--test", "coordination", "--all-features"], "rust"),
