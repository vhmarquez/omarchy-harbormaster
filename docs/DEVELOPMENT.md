...
PRs #53 and #54 are owner-approved and merged; #11–#12 are complete at
qualified main `82096a3`. The owner authorized #13 on
`codex/m2-13-owned-controls`. [Responsibilities](M2-13-CONTROLS.md) were committed
before production work. Stop for approval of this PR/revision before merge or
dependent #15 work. No deployment or live profile activation is implied.
